document.addEventListener('DOMContentLoaded', function() {
    ...
    const BREATHE_IN_IMAGE = 'img1.png';
    const HOLD_BREATH_IMAGE = 'img2.png';
    const BREATHE_OUT_IMAGE = 'img3.png';
    const change_side_image = 'img4.png';
    
    // Breathing timing constants
    const BREATHE_IN_TIME = 5;    // Breathe in for 4 seconds
    const HOLD_TIME = 7;          // Hold breath for 7 seconds
    const BREATHE_OUT_TIME = 7;   // Breathe out for 8 seconds
    const change_sides_time = 4;         // Pause between cycles
